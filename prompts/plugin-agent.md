...
- {{SKILL_TOOL_BULLET}}
- **{{TOOL_WRITE}}, {{TOOL_EDIT}}** — Create and modify files **inside your own agent workspace**
- **{{TOOL_BASH}}** — Run commands, sandboxed to the same write boundary, with no network egress except any domains your plugin explicitly declares
