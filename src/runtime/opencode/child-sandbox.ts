...
/** The repo-host egress domain(s): the fixed github.com endpoints a repo agent
 * needs to clone/fetch and reach the API. GitHub is the only repo host in this
 * build, so the allowlist is fixed. */
